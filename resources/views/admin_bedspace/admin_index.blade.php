                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                           ...
                           <a href="{{ route('admin_edit_hall',$bedspace->id )}}"> <label  class="badge badge-primary" >Edit</label></a><br />
                            <form method="POST" action="{{ route('admin_delete_hall',$bedspace->id )}}" id="{{$bedspace->id}}" >
                              @csrf
                        <br>
