        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item" href="{{ route('admin_student_list')}}">
                ...
                <div class="preview-item-content">
                  ...
                  <a class="dropdown-item preview-item" href="{{ route('admin_public_user_list')}}">
                  <div class="preview-item-content">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <img class="img-xs rounded-circle" src="{{ asset('images/faces/face1.jpg')}}" alt="Profile image">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <hr>
                                    <span class="dropdown-item" style="cursor: pointer;" data-toggle="modal" data-target="#Modal">
                                        {{ __('Edit email') }}
                                    </span>
                                </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Edit email</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="{{route('admin_email_edit')}}" method="POST">
          @csrf
    ...
    <div class="container-fluid page-body-wrapper " >
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-image: url({{asset('images/cm6.png')}});background-size:300px ;background-repeat: no-repeat; background-attachment: fixed">
        <ul class="nav" style="position: fixed">
          ...
          <div class="text-wrapper" style=" margin-right: 30px">
                  ...
                  <div>
                    <small class="designation text-muted" style="color: #ffffff">System Administrator</small>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('admin_student_list')}}">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin_public_user_list')}}">
         ...
         <li class="nav-item" style="background-color: hsla(360, 100%, 100%, 0);">
            ...
            <div class="collapse" id="hall" style="background-color: hsla(360, 100%, 100%, 0);">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" style="color: #ffffff"  href="{{ route('admin_add_hall')}}"><i style="color: #ffffff"  class="menu-icon  mdi  mdi-playlist-plus"></i>Add Hall</a>
                </li>
                <li class="nav-item"> 
                  <a class="nav-link" style="color: #ffffff"  href="{{ route('admin_hall_list')}}"><i style="color: #ffffff" class="menu-icon  mdi mdi-format-list-bulleted"></i>Hall List</a>
                </li>
              </ul>
            </div>
          </li>
      ...
      <li class="nav-item" style="background-color: hsla(360, 100%, 100%, 0);">
            ...
            <div class="collapse" id="general_public" style="background-color: hsla(360, 100%, 100%, 0);">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" style="color: #ffffff" href="{{ route('admin_add_facility')}}"><i style="color: #ffffff" class="menu-icon  mdi  mdi-playlist-plus"></i>Add facility</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" style="color: #ffffff" href="{{ route('admin_facility_list')}}"><i style="color: #ffffff" class="menu-icon  mdi mdi-format-list-bulleted"></i>Facility List</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" style="color: #ffffff" href="{{ route('admin_public_summary')}}"><i style="color: #ffffff" class="menu-icon  mdi mdi-library-books"></i>Booking Summary</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <!--<li class="nav-item">
            <a class="nav-link" href="{{ route('admin_programmes')}}">
              <i  style="color: #ffffff" class="menu-icon mdi mdi-school"></i>
              <span class="menu-title" style="color: #ffffff">Programmes</span>
            </a>
          </li>-->


          <li class="nav-item" style="background-color: hsla(360, 100%, 100%, 0);">
            <a class="nav-link" data-toggle="collapse" href="#manage_users" aria-expanded="false" aria-controls="ui-basic">
              <i style="color: #ffffff" class="menu-icon  mdi mdi-settings"></i>
              <span class="menu-title" style="color: #ffffff">Manage users</span>
              <i class="menu-arrow" style="color: #ffffff"></i>
            </a>
            <div class="collapse" id="manage_users" style="background-color: hsla(360, 100%, 100%, 0);">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" style="color: #ffffff" href="{{ route('admin_estate_users')}}"><i style="color: #ffffff" class="menu-icon  mdi  mdi-playlist-plus"></i>Estates</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" style="color: #ffffff" href="{{ route('admin_students')}}"><i style="color: #ffffff" class="menu-icon  mdi mdi-playlist-plus"></i>Students</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('admin_programmes')}}">
              <i  style="color: #ffffff" class="menu-icon mdi mdi-playlist-plus"></i>
              <span class="menu-title" style="color: #ffffff">Programmes</span>
            </a>
                </li>
              </ul>
