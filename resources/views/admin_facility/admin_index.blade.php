                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                           ...
                           <a href="{{ route('admin_edit_facility',$facility->id )}}"> <label  class="badge badge-primary" >Edit</label></a><br />
                            <form method="POST" action="{{ route('admin_delete_facility',$facility->id )}} " id="{{$facility->id}}" >
                              @csrf
                          <br>
